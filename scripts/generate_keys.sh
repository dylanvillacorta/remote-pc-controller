...
{
    printf "==============================================================================\n"
    printf "          CLAVES Y SECRETOS GENERADOS CORRECTAMENTE (WSL / Linux)             \n"
    printf "==============================================================================\n"
    printf "\n"
    printf ">>> 1. PARA EL ARCHIVO .env DE RELAY (deploy/.env):\n"
    printf "------------------------------------------------------------------------------\n"
    printf "API_SECRET=%s\n" "${API_SECRET}"
    printf "PRIVATE_KEY=\"%s\"\n" "${PRIVATE_KEY_ONELINE}"
    printf "------------------------------------------------------------------------------\n"
    printf "\n"
    printf ">>> 2. PARA EL ARCHIVO .env DE SENTINEL (PC Windows):\n"
    printf "------------------------------------------------------------------------------\n"
    printf "PUBLIC_KEY=\"%s\"\n" "${PUBLIC_KEY_ONELINE}"
    printf "------------------------------------------------------------------------------\n"
    printf "\n"
    printf ">>> 3. TOKEN PARA LA CABECERA DE SIRI / ATAJOS (SHORTCUTS):\n"
    printf "------------------------------------------------------------------------------\n"
